          ...
          <div>
            ...
            <div className="flex gap-2 mt-1">
              ...
              <button
                ...
                disabled={geoLoading}
                className="flex items-center gap-1.5 px-3 py-2 hover:brightness-110 rounded-lg text-sm disabled:opacity-50 whitespace-nowrap" style={{ background: 'linear-gradient(135deg, #2563EB, #3B82F6)', color: '#FFFFFF' }}
              >
