...
function PrBairrosMapComponent({ municipio, votesData, selectedBairro, onBairroClick, height = '100%' }: PrBairrosMapProps) {
  ...
  useEffect(() => {
    ...
    fetch('/geojson/PR_bairros_CD2022.json')
      .then(r => r.json())
      .then((data: any) => {
        const filtered = {
...
export default PrBairrosMapComponent;
