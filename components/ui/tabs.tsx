...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      // Estado ativo — superfície clara + acento dourado
      'data-[state=active]:bg-navy-elev data-[state=active]:text-white',
      'data-[state=active]:shadow-[inset_0_0_0_1px_hsl(var(--gold)/0.35)]',
      className
    )}
    {...props}
  />
