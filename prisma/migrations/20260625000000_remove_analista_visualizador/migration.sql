...
UPDATE "users" SET role = 'ASSESSOR' WHERE role IN ('ANALISTA', 'VISUALIZADOR');

-- Remove o default antes de alterar o tipo
...
ALTER TABLE "users" ALTER COLUMN role SET DEFAULT 'ASSESSOR'::"UserRole";
